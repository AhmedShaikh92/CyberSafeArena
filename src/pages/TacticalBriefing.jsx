...
const SCENARIO_PLAIN = {
  brute_force: {
    ...
    attackerMistakes: [
      'Going too slow — the defender will patch everything',
      'Ignoring the rate limit — it will shut you down',
    ],
    defenderMistakes: [
      'Waiting too long to block — every second counts',
      "Forgetting to enable rate limiting — it's your best weapon",
    ],
  },
  ...
  sql_injection: {
    ...
    attackerMistakes: [
      'Hitting only one entry point — try them all',
      'Not exfiltrating fast enough after a successful injection',
    ],
    defenderMistakes: [
      'Skipping input validation — it stops most attacks instantly',
      'Patching slowly while the attacker pivots to another entry point',
    ],
  },
  ...
  xss: {
    ...
    attackerMistakes: [
      "Not acting before the defender enables CSP — it's game over after that",
      'Only targeting one input field — spread out',
    ],
    defenderMistakes: [
      "Delaying CSP — it's the single most powerful move you have",
      'Patching fields one by one while ignoring the others',
    ],
  },
  ...
  phishing: {
    ...
    attackerMistakes: [
      'Sending too few emails — spam the system to maximize hits',
      'Ignoring credential risk — that number tells you how well you are doing',
    ],
    defenderMistakes: [
      'Reacting slowly — once credentials leak, the round is nearly over',
      'Not blocking emails early — prevention beats damage control',
    ],
  },
  ...
  jwt_manipulation: {
    ...
    attackerMistakes: [
      "Waiting too long — the defender's one-click fix kills your entire strategy",
      'Not escalating privileges fast enough after forging',
    ],
    defenderMistakes: [
      "Not enabling Token Validation immediately — it's your best move",
      'Ignoring role claims — attackers exploit permission escalation',
    ],
  },
  ...
  network_anomaly: {
    ...
    attackerMistakes: [
      "Not attacking continuously — gaps give the defender time to recover",
      'Ignoring system health — watch it drop to know when you are winning',
    ],
    defenderMistakes: [
      "Not enabling DDoS Protection first — everything else comes second",
      "Trying to block IPs before the shield is up — you won't keep up",
    ],
  },
}
